    ...
    useEffect(() => {
        ...
        if (error) {
            ...
            switch (messageParam) {
                case "email_verified":
                    setStatus("success");
                    setMessage("Email verified successfully! Welcome to EventSphere.");
        ...
        <div className="min-h-screen relative flex items-center justify-center p-4">
            ...
            <div className="w-full max-w-md relative z-10 bg-white shadow-2xl rounded-lg">
                <div className="text-center p-8">
                    ...
                    <p className="text-gray-600 text-sm mb-6">{message || "Processing your email verification..."}</p>

                    <div className="space-y-4">
                        {status === "success" && (
                            <div className="p-4 bg-green-50 rounded-lg">
                                <p className="text-sm text-green-700">You will be redirected to the home page in a few seconds...</p>
                            </div>
                        )}
                        ...
                        {status === "error" && (
                            <>
                                ...
                                <div className="text-center">
                                    <a href="/verify-email" className="text-purple-600 hover:text-purple-700 font-medium text-sm">
