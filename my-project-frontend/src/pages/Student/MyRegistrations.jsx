                ...
                <>
                    ...
                    <div className="hidden lg:block overflow-x-auto">
                        <table className="w-full">
                            ...
                            {items.length > 0 ? items.map((registration) => (
                                <tr
                                    key={registration.id}
                      ...
                      <span
                        ...
                        {registration.status}
                                    ...
                                    <td className="px-3 py-4 text-sm font-medium flex gap-2 justify-center">
                                        <button onClick={() => navigate(`/event/${registration.eventId}`)}
                                                className="cursor-pointer text-purple-600 hover:text-white bg-purple-100 hover:bg-purple-600 px-3 py-2 rounded-lg transition-all duration-300">
                                            View Details
                                        </button>
                                    </td>
                                </tr>
                    ...
                    {registration.status}
                                ...
                                <div className="flex gap-2 mt-4">
                                    <button
                                        className="cursor-pointer flex-1 text-purple-600 hover:text-white bg-purple-100 hover:bg-purple-600 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-300">
                                        View Details
                                    </button>
