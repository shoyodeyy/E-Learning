                ...
                <div className="p-4">
                    <div className="bg-white rounded-lg border border-gray-200 p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <p className="px-3 py-2 border border-gray-200 rounded-lg bg-gray-100">
                                {event.title}
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="px-3 py-2 border border-gray-200 rounded-lg bg-gray-100 whitespace-pre-line">
                                {event.description}
                            </p>
                        </div>
