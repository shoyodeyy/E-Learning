    ...
    return (
        <div
            ...
            <div className="relative">
                <img src={`http://localhost:8000${event.bannerImage}`} alt={event.title}
                ...
                <div className="absolute top-3 right-3">
                    <span className={`px-2 py-1 text-xs font-medium text-white rounded}`}>{event.slots}</span>
                </div>
            </div>
                ...
                {event.status !== "pending_delete" ? (
                    <div className="flex items-center space-x-2">
                        <Link
                            ...
                            className="cursor-pointer p-2 text-yellow-400 hover:text-yellow-600 transition-colors"
                        >
                            <Edit size={16} />
                        </Link>
